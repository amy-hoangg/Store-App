...
const generateId = () => {
  const generateUniqueId = () => {
    ...
    if (data.users.some(u => u._id === id)) {
      // If it is, recursively call the function to generate a new id
 ...
 * @returns {object|undefined} a copy of the found user and not the original
 */
 ...
 * @returns {object|undefined} a copy of the user and not the original
 */
 ...
 *
 * @param {string} userId id of user
 * @returns {bbject|undefined} deleted user or undefined if user does not exist
 */
